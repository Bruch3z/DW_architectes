$(document).ready(function() {
    ...
    // Toggle popover and update underlined class on A propos button click
    ...
    // Hide popover on body click only if the click is outside the "À propos" button or the popover
